from password_strength import PasswordStats #install password_strength library in cmd with pip install
...
head=tk.Label(window,text="Password Strength calculator",font=("helvetica",15,"bold"))
